"""
TFLite conversion script for hand gesture recognition model.
...
def convert_to_tflite(keras_model_path='handtalk_model.keras', 
                     tflite_model_path='handtalk_model.tflite',
    ...
    tflite_model_path = 'output/tflite_model/handtalk_model.tflite'
    labels_txt_path = 'output/labels/labels.txt'
    ...
    try:
        with open('label_encoder.pkl', 'rb') as f:  # Load from original location
...
def validate_tflite_model(tflite_model_path='output/tflite_model/handtalk_model.tflite'):
    """
...
def main():
    ...
    """
    print("="*60)
    print("TENSORFLOW LITE CONVERSION FOR HAND GESTURE MODEL")
    print("="*60)
    ...
    if validation_success:
        ...
        print("  - output/tflite_model/handtalk_model.tflite (TFLite model for Android)")
        print("  - output/labels/labels.txt (text labels for Android)")
        ...
        print("Output: probability distribution over gesture classes")
    else:
